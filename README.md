...
|---|---|---|
| `messenger-whatsapp-cloud-v1` | Early MVP (text/media URL send + access validation) | None in this repo yet |
| `messenger-telegram-bot-v1` | Early MVP (text/media URL send + access validation) | None in this repo yet |
| `messenger-signal-bridge-v1` | Early MVP (text send + access validation) | None in this repo yet |
...
|---|---|---|---|---|---|---|
| WhatsApp Cloud | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ❌ |
| Telegram Bot | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ❌ |
| Signal Bridge | ⚠️ | ⚠️ | ❌ | ⚠️ | ⚠️ | ❌ |
